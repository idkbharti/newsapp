...
export default function Loding() {
  return (
    <>
 <div className="flex flex-wrap lg:1/4 md:1/3 gap-20 justify-center  mt-20">


       <div role="status" className="p-5   rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700">
